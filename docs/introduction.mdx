...
* **Secure access.**  Manage access to sensitive information, through permissions.  Grant permission to see aggregate reports as needed without revealing more than necessary.
...
* Reports like lapsed and expiring members
