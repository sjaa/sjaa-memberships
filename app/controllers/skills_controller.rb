class SkillsController < ApplicationController
  ...
  def show
    @people_with_skill = @skill.active_members.includes(:contacts, :memberships)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @skill.save
        ...
        format.json { render json: @skill.errors, status: :unprocessable_content }
      end
    end
  end
  ...
  private
    ...
    def skill_params
      params.require(:skill).permit(:name, :description, :email)
    end
end
